...
void addBPDPlan(startDate) {
  ...
  MyList.meetings.add(Meeting(
    ...
    eventName: 'Rejuvanation, Journal',
    background: const Color(0xFFF8B600),
    isAllDay: true,
    description: "BPD Coping Plan",
  ));
  ...
  MyList.meetings.add(Meeting(
    ...
    eventName: 'Breathing with Purpose, Meditation',
    background: const Color(0xFFF8B600),
    isAllDay: true,
    description: "BPD Coping Plan",
  ));
  ...
  MyList.meetings.add(Meeting(
    ...
    eventName: 'PEMS, Breathing with Purpose',
    background: const Color(0xFFF8B600),
    isAllDay: true,
    description: "BPD Coping Plan",
  ));
  MyList.meetings.add(Meeting(
    ...
    eventName: 'Affirmations, Journal',
    background: const Color(0xFFF8B600),
    isAllDay: true,
    description: "BPD Coping Plan",
  ));
